...
public class GruppeAStudyhelpPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "GruppeAStudyhelp";
	...
	private GruppeAStudyhelpPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.studyhelp.model.Benutzer.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.studyhelp.model.Dozent.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.studyhelp.model.Forum.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.studyhelp.model.Student.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.studyhelp.model.Veranstaltung.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.studyhelp.model.Kurstermin.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.studyhelp.model.Lernmaterial.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.studyhelp.model.Lehrveranstaltung.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.studyhelp.model.Studiengang.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.studyhelp.model.Stellenangebot.class);
		aMetadataSources.addAnnotatedClass(de.hhn.ai.pmt.studyhelp.model.Firma.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new GruppeAStudyhelpPersistentManager();
		}
